...
VERSION = "master_pipeline_v1"


def run(*, rebuild_tariffs: bool = False, build_archives: bool = False, extended: bool = False, overwrite: bool = False) -> dict:
...
def main() -> int:
    ...
    print(json.dumps(run(rebuild_tariffs=args.rebuild_tariffs, build_archives=args.build_archives, extended=args.extended, overwrite=args.overwrite), indent=2))
    return 0
