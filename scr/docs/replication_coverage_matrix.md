...
| 2013–2025 raw trade extension | Trade panel builders | extension v1 staging projection | `ran_no_gate` | 312/312 ZSTD Parquet partitions; imports 39,640,207 rows and exports 50,400,363 rows; staging reconciliation passes; stratified ZIP audit passes | Full archive-level validation and concordance audit pending; archive-native v2 only smoke-tested |
